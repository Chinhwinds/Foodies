<%-- 
    ...
    Created on : Jul 5, 2024, 4:01:21 PM
    Author     : Admin
--%>
    ...
    <body>
        <div class="containers">
            ...
            <main class="main-content">
                ...
                <a class="icon-one" href="/adminUser"><i class="fa-solid fa-circle-arrow-left inner-icon-one"></i></a>
                                ...
                                <div class="inner-body">
                                    <form action="/adminUser" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="catName" name="txtName" readonly value="${sessionScope.user.username}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control" name="gender" id="gens" readonly>
                                                    <c:if test="${sessionScope.user.gender == 'male'}">
                                                        <option name="gender" value="${sessionScope.user.gender}" selected="">Male</option>
                                                    </c:if>
                                                    <c:if test="${sessionScope.user.gender == 'female'}">
                                                        <option name="gender" value="${sessionScope.user.gender}" selected="">Female</option>
                                                    </c:if>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" id="catName" name="txtEmail" value="${sessionScope.user.email}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="catName" class="col-sm-2 col-form-label">Phone</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="catName" name="txtPhone" value="${sessionScope.user.phone}" readonly>
                                            </div>
                                        </div>
...
<!--                                        error notification
                                        ...
                                        <div class="col-xl-12 text-center">
                                            <button type="submit" class="button" name="btnUserEdit" value="btnEdit">Edit</button>
                                        </div>-->
                                    </form>
                                </div>
                            </div>
