...
<html>
    ...
    <body>
        <%
            AdminCategory obj = (AdminCategory) session.getAttribute("edit");
        %>
                    ...
                    <div class="title">
                        ...
                        <nav class="breadcrumbs">
                            <a href="/admin">Home</a> / <a href="/adminDashboard">Dashboard</a> / <a
                                href="/admin/adminProduct">Products</a> / <a href="/admin/adminProduct/categoryEdit/">Category</a>
                        </nav>
                    </div>
                                ...
                                <div class="inner-body">
                                    <form method="post" >
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control-plaintext" id="catID" name="txtID"
                                                       readonly value="<%= obj.getCatID()%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="catName" class="col-sm-2 col-form-label">Category Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="catName" name="txtName" value="<%= obj.getCatName()%>" required="">
                                            </div>
                                        </div>
                                        <div class="col-xl-12 text-center">
                                            <button type="submit" class="button" name="btnCatEdit">Edit</button>
                                        </div>
