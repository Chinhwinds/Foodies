<%-- 
    Document   : adminReportList
    Created on : Jul 10, 2024, 6:21:20 AM
    Author     : asus1
--%>

<%@page import="Models.AdminReport"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/CSS/adminReportList.css"/>
    </head>
    <body>
        ...
        <c:set var="listID" value="${sessionScope.list.shopID}" />
