<%-- 
    Document   : adminDashboardSalesProduct
    Created on : Jul 10, 2024, 7:16:47 PM
    Author     : Admin
--%>
                ...
                <header class="header">
                    <div class="title">
                        ...
                        <nav class="breadcrumbs">
                            <a href="/admin">Home</a>/ <a href="/adminDashboard">Dashboard</a>/ <a href="/adminDashboard/SalesProduct">SalesProduct</a>
                        </nav>
                    </div>
                ...
                <section class="dashboard-widgets">
                    <div class="widget widget-4">
                        ...
                        <table class="tbl">
                            ...
                            <tbody>
                                <c:forEach items="${sessionScope.dashboardSalesInfo}" var="i">
                                    <tr>
                                        <td>${i.name}</td>
                                        <td>${i.quantity}</td>
                                        <td>${i.price}</td>
